...
class _SearchResultsState extends State<SearchResults> {
  ...
  void fetchData(String q) async {
    var url =
        "https://newsapi.org/v2/top-headlines?q=${q}&apiKey=c44d7e2b78a943549f159ec7ad7482d0";
                              ...
                              child: Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Padding(
                                      ...
                                      child: Text(
                                          "${_data["articles"][index]["title"].length<55 ? _data["articles"][index]["title"] : _data["articles"][index]["title"].substring(0, 55) + "..."}"),
                                    ),
                                    subtitle:
                                        Padding(
                                          padding: const EdgeInsets.all(4.0),
